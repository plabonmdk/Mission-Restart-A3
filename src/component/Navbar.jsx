  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        {/* Mobile Toggle */}
        <div className="md:hidden text-2xl cursor-pointer text-[#632EE3]" onClick={() => setIsOpen(!isOpen)}>
      ...
      >
        <NavLink
          ...
          className={({ isActive }) => `flex items-center gap-2 ${isActive ? "text-[#632EE3] font-semibold" : "text-gray-600 hover:text-[#632EE3]"}`}
        >
          <FaHome /> Home
        </NavLink>
